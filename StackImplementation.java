// 2. Design a stack that supports push,pop,top,and retrieving the minimum element in constant time.and you must implement a solution with O(1) time complexity for each function.
